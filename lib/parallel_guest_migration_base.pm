...
tie our %guest_migration_matrix_kvm, 'Tie::IxHash', (
    ...
    virsh_live_native_p2p_manual_postcopy => 'sleep 120 && virsh --connect=srcuri --debug=0 migrate --verbose --live --p2p --persistent --change-protection --unsafe --compressed --abort-on-error --postcopy --undefinesource guest dsturi#virsh --connect=srcuri --debug=0 migrate-postcopy guest',
    virsh_offline_native_p2p => 'sleep 120 && virsh --connect=srcuri --debug=0 migrate --verbose --offline --p2p --persistent --unsafe --undefinesource guest dsturi');
