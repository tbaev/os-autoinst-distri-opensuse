...
sub run {
    ...
    assert_script_run("curl -k https://larry.qe.suse.de:444/");
    assert_script_run("curl -4 -k https://larry.qe.suse.de:444/");
    assert_script_run("curl -6 -k https://larry.qe.suse.de:444/");
